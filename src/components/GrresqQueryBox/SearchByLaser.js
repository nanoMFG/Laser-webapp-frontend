...
const SearchByLaser = () => {
  ...
  const onClickAdd = () => {
    ...
    toolDispatch({
      type: 'ADD_FILTER',
      payload: {
        type: 'MIN_MAX', category: 'laser', name, min, max
      }
    })
  }
      ...
      <div className='flex flex-row md:w-2/3 justify-center my-2'>
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
            ...
            id="laser-min" type="number" step={defaultPrecision} value={min}
        ...
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            id="laser-max" type="number" step={defaultPrecision} value={max}
